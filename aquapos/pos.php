...
<div class="pos-layout">
    ...
    <!-- LEFT: Products + Refill -->
    <div class="products-panel">

        <!-- MODE TABS: Products | Refill -->
        <div class="mode-tabs">
            <button class="mode-tab active" id="modeProducts" onclick="switchMode('products')">
                📦 Products
            </button>
            <button class="mode-tab" id="modeRefill" onclick="switchMode('refill')">
                💧 Refill
            </button>
        </div>

        <!-- PRODUCTS PANEL -->
        <div id="productsModePanel">
        ...
        <!-- REFILL PANEL -->
        <div id="refillModePanel" style="display:none">
            <div class="refill-header">
                <div style="font-size:13px;color:var(--muted)">Customer brings their own container — select size to refill</div>
            </div>
            <div class="refill-grid" id="refillGrid">
                <div class="loading"><div class="spinner"></div> Loading refill options…</div>
            </div>
        </div>
    </div>
