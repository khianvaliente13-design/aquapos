...
CREATE TABLE products (
    ...
    refill_price DECIMAL(10,2) NOT NULL DEFAULT 0.00,
...
-- Products
INSERT INTO products (category_id, name, price, stock, unit, refill_price) VALUES
(1, '5-Gallon Purified',  35.00, 100, 'gallon', 20.00),
(1, '1-Gallon Purified',  12.00, 100, 'gallon', 8.00),
(1, 'Slim Bottle 500ml',   8.00, 200, 'bottle', 5.00),
(2, '5-Gallon Mineral',   40.00, 80,  'gallon', 25.00),
(2, '1-Gallon Mineral',   15.00, 80,  'gallon', 10.00),
(3, 'Gallon Container',  150.00, 30,  'piece', 0.00),
(3, 'Water Pump',        120.00, 20,  'piece', 0.00);
...
-- Default refill options
INSERT INTO refills (name, description, price, sort_order) VALUES
('5-Gallon Refill',    'Refill for standard 5-gallon round container', 20.00, 1),
('1-Gallon Refill',    'Refill for 1-gallon container',               8.00,  2),
('Slim Bottle Refill', 'Refill for slim 500ml bottle',                5.00,  3),
('Customized Refill',  'Other container sizes — ask cashier',         0.00,  4);
